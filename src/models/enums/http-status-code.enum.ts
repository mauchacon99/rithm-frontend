 ...
 */
 export enum HttpStatusCode {
   ...
   * If-None-Match. In such case, there is no need to retransmit the resource since the client still has a previously-downloaded copy.
   */
  NotModified = 304,
   ...
   * Many HTTP clients (such as Mozilla and Internet Explorer) do not correctly handle responses with this status code, primarily
   ...
   * "unauthenticated": the user does not have the necessary credentials.
   */
  Unauthorized = 401,
