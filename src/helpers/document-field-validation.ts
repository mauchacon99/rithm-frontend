...
export class documentFieldValidation {
  ...
  /** Regex to check number input. */
  private number_regex = new RegExp(/^[0-9]*\.?[0-9]*$/);
  ...
  /**
   * Check if number field is correctly entered.
   *
   * @returns A validator function.
   */
  numberValidation(): ValidatorFn {
    return this.testRegExp(this.number_regex, 'numberIncorrect');
  }
